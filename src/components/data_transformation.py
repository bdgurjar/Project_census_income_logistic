    ...
    def get_data_transformation_object(self):
        try:
            ...
            cat_onehot_pipeline=Pipeline(
                ...
                ("onehotencoder",OneHotEncoder(categories=[workclass_cat,education_cat,education_num_cat,marital_status_cat,occupation_cat,relationship_cat,race_cat,sex_cat,native_country_cat],sparse_output=False)),
                ("scaler",StandardScaler())
                ]
